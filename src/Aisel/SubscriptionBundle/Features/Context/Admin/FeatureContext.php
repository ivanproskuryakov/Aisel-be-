...
namespace Aisel\SubscriptionBundle\Features\Context\Admin;

use Aisel\ResourceBundle\Features\Context\SonataAdminContext;

/**
 * Behat CRUD for subscription entities
 */
class FeatureContext extends SonataAdminContext
{
    ...
    /**
     * @When /^I visit subscription list route admin_aisel_subscription_subscription_list$/
     */
    public function browseToSubscriptionListRoute()
    {
        $this->getSession()->visit($this->generateUrl('admin_aisel_subscription_subscription_list', array('_locale' => 'en')));
