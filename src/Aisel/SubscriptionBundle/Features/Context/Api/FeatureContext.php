...
namespace Aisel\SubscriptionBundle\Features\Context\Api;
...
class FeatureContext extends DefaultContext
{
    ...
    /**
     * @When /^Script access api_aisel_subscription_details route$/
     */
    public function scriptAccessRoute()
    {
        $this->getSession()->visit($this->generateUrl('api_aisel_subscription_details'));
